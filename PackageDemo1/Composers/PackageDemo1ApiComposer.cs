...
namespace PackageDemo1.Composers
{
    public class PackageDemo1ApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Package Demo 1Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PackageDemo1OperationSecurityFilter>();
            });
        }

        public class PackageDemo1OperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("PackageDemo1.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
