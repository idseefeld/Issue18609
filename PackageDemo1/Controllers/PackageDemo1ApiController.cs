...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "PackageDemo1")]
    public class PackageDemo1ApiController : PackageDemo1ApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public PackageDemo1ApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
