...
namespace PackageDemo2.Composers
{
    public class PackageDemo2ApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Package Demo 2Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<PackageDemo2OperationSecurityFilter>();
            });
        }

        public class PackageDemo2OperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("PackageDemo2.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
