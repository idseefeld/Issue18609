...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "PackageDemo2")]
    public class PackageDemo2ApiController : PackageDemo2ApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public PackageDemo2ApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
